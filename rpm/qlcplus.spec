...
%defattr(-,root,root)
/usr/bin/qlcplus
/usr/%{_lib}/libqlcplusengine*
/usr/%{_lib}/libqlcplusui*
/usr/%{_lib}/libqlcpluswebaccess*
...
/usr/%{_lib}/qt4/plugins/qlcplus/libartnet.so
/usr/%{_lib}/qt4/plugins/qlcplus/libhidplugin.so
/usr/%{_lib}/qt4/plugins/qlcplus/libosc.so
/usr/%{_lib}/qt4/plugins/qlcplus/libpeperoni.so
/usr/%{_lib}/qt4/plugins/qlcplus/libenttecwing.so
/usr/%{_lib}/qt4/plugins/qlcplus/libmidiplugin.so
/usr/%{_lib}/qt4/plugins/qlcplus/libdmx4linux.so
/usr/%{_lib}/qt4/plugins/qlcplus/libdmxusb.so
/usr/%{_lib}/qt4/plugins/qlcplus/libudmx.so
/usr/%{_lib}/qt4/plugins/qlcplus/libe131.so
/usr/%{_lib}/qt4/plugins/qlcplus/libspi.so
